    ...
    public static void main(String[] args) {
        ...
        for(CITY city : CITY.values()) {
            System.out.printf("%d\t%s(%s)%n"
              , city.ordinal(), city.getDestination(), city.name());
        }
        ...
        if(retCity == null) {
            ...
            switch (retCity) { 
                case SEOUL   -> System.out.printf("\n%s로 출발합니다"
                                   , CITY.SEOUL.getDestination()); 
                case DAEJEON -> System.out.printf("\n%s로 출발합니다"
                                   , CITY.DAEJEON.getDestination()); 
                case DAEGU   -> System.out.printf("\n%s로 출발합니다"
                                   , CITY.DAEGU.getDestination()); 
                case PUSAN   -> System.out.printf("\n%s로 출발합니다"
                                   , CITY.PUSAN.getDestination()); 
                case GWANGJU -> System.out.printf("\n%s로 출발합니다"
                                   , CITY.GWANGJU.getDestination()); 
